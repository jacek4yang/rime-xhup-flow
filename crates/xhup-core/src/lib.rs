//! XHUP Flow 领域核心:XHUP 键盘码的底层表示、规范双拼布局、规范输入音节清单、音节编码与规范汉字读音。
//!
//! 内建规范小鹤双拼布局、规范输入音节清单与规范汉字读音表经 `include_str!` 嵌入仓库级项目数据
//! `data/double_pinyin/`、`data/pinyin/`、`data/hanzi/`(唯一事实来源);内建数据假定当前 XHUP Flow
//! 仓库的目录结构。
//!
